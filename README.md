...
1. `results/`: Contains the .csv output files generated by the simulations, i.e. body positions over time for both the $O(N^2)$ naive method and the Barnes-Hut algorithm.
