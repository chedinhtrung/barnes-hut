...
int main() {
    ...
    Simulation simBH(bodies_bh, DT, BH_CSV, &classic_gfield);
    Simulation simNaive(bodies_naive, DT, NAIVE_CSV, &classic_gfield);

    Simulation simBH_R3Gravity(bodies_bh_r3_gravity, DT, R3Gravity_BH_CSV, &r3_gfield);
